...
module.exports = {
  ...
  warning: {
    ...
    largeDriveSize: (humanDriveSize) => {
      return [
        'It looks like you\'re trying to flash a large drive of size <%= humanDriveSize %>,',
        'this could potentially be a backup drive containing important data.',
      ].join(' ')
    }
